...
یەکەم جار، با پێداچوونەوە بکەین لەسەر گۆڕانکاری کردنی  لە لیستەکان لە جاڤاسکریپتدا.
...
کاتێک ئەم کۆدە ڕەن دەکەیت، ئاگاداریەک وەردەگریت کە ئەڵێت ئاتیمەکانی لیستەکە پێویستە کی یان هەبێت.کی تایبەتمەندیەکە کە نرخەکەی پیت یان ژمارەی بێ وێنەیە کاتێک لیست لە ئیلیمێنت دروست دەکەیت پێویستە هەیان بێت.گفتوگۆی لەسەر دەکەین کە بۆچی کی گرنگە لە بەشی داهاتوودا.
...
کییەکان یارمەتی ڕیائاکت دەدەن کە بزانێت چی ئاییتمێک گۆڕانکاری بەسەر هاتووە، زیاد کراوە یاخود سڕاوەتەوە.
